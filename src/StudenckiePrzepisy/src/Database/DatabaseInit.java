...
public class DatabaseInit {
    ...
    private ArrayList<Skladnik> skladniki = new ArrayList<Skladnik>();
    ...
    Przepis przepisy[] = {
            ...
            new Przepis(3, 5, "Jajka w majonezie", "Ogórek, rzodkiewki i koperek drobno pokrój. Jajka przekrój na pół, wyjmij żółtka, połącz z Majonezem i warzywami. Dopraw do smaku solą i pieprzem. Z masy formuj kulki i nakładaj je do białek. Przed podaniem jajka posyp koperkiem." ,"3.jpg"),
            ...
            new Przepis (11, 4, "Szybki deser truskawkowy" , "Truskawki kroimy w ćwiartki serek homogenizowany mieszamy z paroma łyżkami otrębów układamy warstwowo otręby, serek, otręby, truskawki, serek (lub jak kto woli inną kolejność) i zajadamy ;) smakuje genialnie! ;)" ,"11.jpg"),
            new Przepis (12, 4, "Koktajl truskawkowy" , "Przepis jest stosunkowo prosty. Wkładamy wszystko do jakiegoś naczyńka i miksujemy :) Najlepszy schłodzony. Smacznego!" ,"12.jpg"),
            new Przepis (13, 3, "Sałatka z papryki" , "Paprykę i cebulę pokroić w drobną kostkę. Pomidory sparzyć, obrać, usunąć gniazda nasienne. Pokroić w kostkę. Wszystkie składniki przełożyć do miski. Dodać majonez oraz śmietanę. Doprawić solą i pieprzem, dokładnie wymieszać.!" ,"13.jpg"),
